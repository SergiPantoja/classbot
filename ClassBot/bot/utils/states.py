...
EDIT_CLASSROOM_CHOOSE_OPTION, EDIT_CLASSROOM_NAME, EDIT_CLASSROOM_PASSWORD, EDIT_CLASSROOM_CHANGE, EDIT_CLASSROOM_REMOVE_STUDENT, EDIT_CLASSROOM_REMOVE_TEACHER, EDIT_CLASSROOM_DELETE_CONFIRM, EDIT_CLASSROOM_CHANNELS, EDIT_CLASSROOM_CHANNELS_ADD = range(9)
...
T_PENDING_SELECT, T_PENDING_OPTIONS, T_PENDING_ASSIGN_TEACHER, T_PENDING_REJECT, T_PENDING_APPROVE, T_PENDING_MORE_INFO, T_PENDING_FILTER_ACTIVITY, T_PENDING_APPROVE_PARTIAL_CREDITS, T_PENDING_FILTER_PRACTIC_CLASS = range(9)
...
# student_practic_classes states
S_SELECT_PRACTIC_CLASS, S_PRACTIC_CLASS_NEW_TITLE_PROPOSAL, S_EXERCISE_SELECT, S_EXERCISE_SEND_SUBMISSION, S_EXERCISE_SEND_SUBMISSION_DONE = range(5)
