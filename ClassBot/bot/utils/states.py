...
T_PENDING_SELECT, T_PENDING_OPTIONS, T_PENDING_ASSIGN_TEACHER, T_PENDING_REJECT, T_PENDING_APPROVE, T_PENDING_MORE_INFO, T_PENDING_FILTER_ACTIVITY, T_PENDING_APPROVE_PARTIAL_CREDITS = range(8)
