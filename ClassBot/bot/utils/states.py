...
T_CP_CREATE, T_CP_CREATE_STRING, T_CP_CREATE_DATE, T_CP_CREATE_DESCRIPTION, T_CP_CREATE_FILE, T_CP_INFO, T_CP_EDIT_DATE, T_CP_EDIT_DESCRIPTION, T_CP_EDIT_FILE, T_CP_DELETE = range(10)
