...
S_ACTIONS_SELECT_ACTION, S_ACTIONS_SEND_MISC, S_ACTIONS_SELECT_INTERVENTION, S_ACTIONS_SEND_INTERVENTION, S_ACTIONS_SEND_RECTIFICATION, S_ACTIONS_SEND_STATUS_PHRASE, S_ACTIONS_SEND_MEME, S_ACTIONS_SEND_JOKE = range(8)
